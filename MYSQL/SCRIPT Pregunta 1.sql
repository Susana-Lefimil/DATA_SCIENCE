...
-- Se importa archivo datos_movie.csv
-- Insertar información a las columnas de a una tabla (dm)
INSERT INTO peliculas.dm(name,	genre,	year, imdb_rating)
...
(	'Transformers: Revenge of the Fallen'	,	'action'	,	'2009'	,	'6'	),
...
(	'How the Grinch Stole Christmas'	,	'comedy'	,	'2000'	,	'6'	),
...
(	'Ted'	,	'comedy'	,	'2012'	,	'7'	),
(	'Aladdin'	,	'comedy'	,	'1992'	,	'8'	),
(	'Alvin and the Chipmunks'	,	'comedy'	,	'2007'	,	'5.3'	),
(	'Madagascar 3: Europes Most Wanted'	,	'comedy'	,	'2012'	,	'7'	),
...
(	'Wedding Crashers'	,	'comedy'	,	'2005'	,	'7'	),
(	'Charlie and the Chocolate Factory'	,	'comedy'	,	'2005'	,	'6.7'	),
(	'Ratatouille'	,	'comedy'	,	'2007'	,	'8'	),
...
(	'Ice Age: Dawn of the Dinosaurs'	,	'comedy'	,	'2009'	,	'7'	),
(	'Ice Age: The Meltdown'	,	'comedy'	,	'2006'	,	'6.9'	),
(	'World War Z'	,	'horror'	,	'2013'	,	'7'	),
...
(	'Slumdog Millionaire'	,	'romance'	,	'2008'	,	'8'	),
...
(	'Dawn of the Planet of the Apes'	,	'drama'	,	'2014'	,	'7.7'	),
(	'Interstellar'	,	'drama'	,	'2014'	,	'8.7'	),
(	'Gladiator'	,	'drama'	,	'2000'	,	'8.5'	),
(	'Dances with Wolves'	,	'drama'	,	'1990'	,	'8'	),
...
(	'Catch Me If You Can'	,	'drama'	,	'2002'	,	'8'	),
...
(	'The Devil and Daniel Johnston'	,	null	,	'2005'	,	'8'	),
(	'Ali Wong: Baby Cobra'	,	null	,	'2016'	,	null	),
(	'The Big Sick'	,	'romance'	,	'2017'	,	null	),
(	'Deadpool'	,	'action'	,	'2016'	,	null	);


SELECT * FROM peliculas.dm;

-- 1. Calcular el rating m´aximo y promedio por g´enero
SELECT  dm.genre, max(dm.imdb_rating) as max, avg(dm.imdb_rating) as prom
...
-- 2. Contar cuantas pel´ıculas no tienen ratings
SELECT count(dm.name) as sin_rating
FROM peliculas.dm
WHERE dm.imdb_rating IS NULL ;

-- 3. Qu´e pel´ıcula tiene el menor ratings, sin considerar las pel´ıculas que no poseen ratings
SELECT  dm.name , dm.imdb_rating
FROM peliculas.dm
WHERE dm.imdb_rating IS NOT NULL
order by  dm.imdb_rating ASC 
limit 1;

-- 4. Qu´e a˜no fue el que obtuvo el meyor ratings promedio, considerando que se tengan a lo menos 6 pel´ıculas ese a˜no
SELECT dm.year, avg(dm.imdb_rating) as prom, count(dm.name) as num_peliculas
FROM peliculas.dm
group by dm.year 
HAVING count(dm.name)>=6
order by prom desc
limit 1;

-- 5. Calcular el ratings promedio por a˜no, que posea una puntuaci´on media entre 6,5 y 7,9.
SELECT dm.year, avg(dm.imdb_rating) as prom
FROM peliculas.dm
group by dm.year 
HAVING avg(dm.imdb_rating)>=6.5 and avg(dm.imdb_rating)<=7.9
