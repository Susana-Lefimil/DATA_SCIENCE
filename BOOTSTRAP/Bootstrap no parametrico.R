...
#Se debe escribir una funcci�n R con la estadistica que queremos calcular las replicas bootstrap
...
#lo que podemos ver ac� es si esa cantidad es probable que sea 0 o no, sacamos intervalos de confianza

c<-sort(b$t)
#Intervalo de confianza:
izquierda<-c[25]
derecha<-c[975]
#Si cero no est� adentro del intervalo, rechazamos la hipotesis que la media sea cero.
izquierda
derecha
